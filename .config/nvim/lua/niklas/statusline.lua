-- Based on https://github.com/wurli/dotfiles/blob/e61c7aa0cd64b6e2c5798931afe0342ef03d35fe/.config/nvim/lua/statusline.lua

local icons = require("niklas.icons")
...
vim.api.nvim_create_autocmd("LspProgress", {
    group = vim.api.nvim_create_augroup("jscott/statusline_lsp", { clear = true }),
...
local file_component = function()
    ...
    local buf_head = vim.fn.fnamemodify(vim.fn.pathshorten(vim.fn.fnamemodify(buf_path, ":~:.")), ":h")
    local buf_ext = vim.fn.fnamemodify(buf_path, ":e")
    local display_name = hl.Directory(buf_head .. "/") .. buf_tail
